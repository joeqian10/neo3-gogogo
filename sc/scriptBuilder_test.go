...
func TestScriptBuilder_Emit(t *testing.T) {
	...
	_ = sb.Emit(SYSCALL, scriptHash.Bytes()...)
	b := sb.ToArray()
...
func TestScriptBuilder_EmitJump(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitJump(JMP, 127)
	_ = sb.EmitJump(JMP, 2147483647)
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt1(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(-1))
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt2(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(0))
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt3(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(-128))
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt4(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(127)) //0b_0111_1111, 0b_1111_1111 = 0d_-1
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt5(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(255)) //0b_00000000_11111111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt6(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(-32768)) //0b_1000_0000_0000_0000
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt7(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(32767)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt8(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(65535)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt9(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(-2147483648)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt10(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(2147483647)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt11(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(4294967295)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt12(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(-9223372036854775808)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt13(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(big.NewInt(9223372036854775807)) //0b_1111_1111_1111_1111
	b := sb.ToArray()
...
func TestScriptBuilder_EmitPushBigInt14(t *testing.T) {
	sb := NewScriptBuilder()
	_ = sb.EmitPushBigInt(new(big.Int).SetUint64(uint64(18446744073709551615))) //0b_1111_1111_1111_1111
	b := sb.ToArray()
